...
dd_cats <- tribble(
  ...
  c("AUDIO_duration"),
  c("-1" = "no information"),
  c("AUDIO_left_frequency_loss_01",
    "AUDIO_left_frequency_loss_02",
    "AUDIO_left_frequency_loss_03",
    "AUDIO_left_frequency_loss_04",
    "AUDIO_left_frequency_loss_05",
    ...
    "AUDIO_left_minimal_masking_level",
    "AUDIO_right_minimal_masking_level"),
  c("888" = "measurement didn't yield a result",
    "999" = "measurement was not done"),
  ...
  c("AUDIO_left_minimal_tinnitus_frequency",
    "AUDIO_left_maximal_tinnitus_frequency",
    "AUDIO_right_minimal_tinnitus_frequency",
    "AUDIO_right_maximal_tinnitus_frequency"),
  c("999" = "measurement was not done"),
  c("AUDIO_residual_inhibition"),
  c("-1" = "no information",
    "0" = "partial",
    "1" = "complete",
    "2" = "duration [sec.]:"),
  c("AUDIO_survey_participation_appropriateness"),
  c("0" = "YES",
    "1" = "NO"),
